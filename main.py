...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet("bullet.png", self.rect.centerx, self.rect.top, 18, 35, -15)
        bullets.add(bullet)
...
finish = False
run = True
display.set_caption("Подоорож в космосі")

font.init()
mainfont =font.SysFont(None, 30)
win = mainfont.render("ТИ ВИГРАВ", True, (255, 255, 255))
lose = mainfont.render("ТИ ПРОГРАВ", True, (255, 0, 0))
score = 0
lost = 0
